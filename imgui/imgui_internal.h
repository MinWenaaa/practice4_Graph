...
//#endif
    ...
    IMGUI_API float         GetColumnNormFromOffset(const ImGuiOldColumns* columns, float cameraTarget);
    ...
    IMGUI_API void          TabBarQueueReorder(ImGuiTabBar* tab_bar, ImGuiTabItem* tab, int cameraTarget);
